...
class StateChangeIndicators extends Component {
  ...
  getStyleMap() {
    return {
      ...
      'spinner': 'opacity: 0.75; border: 16px solid #f3f3f3; border-top: 16px solid #a3a3a3; border-radius: 50%; width: 50px; height: 50px; animation: spin 0.5s linear infinite; z-index: 1000; -webkit-animation: spin 0.5s linear infinite; position: absolute;',
